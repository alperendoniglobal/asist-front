...
import { Loader2, ArrowRight, Phone, FileText } from 'lucide-react';

/**
 * KVKK Page
 * KVKK Aydınlatma Metni sayfası - Backend'den içerik çeker
 */
    ...
    const fetchContent = async () => {
      try {
        ...
        const [content, landing] = await Promise.all([
          contentService.getPageBySlug('kvkk').catch(() => null),
      ...
      <Helmet>
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "WebPage",
            "name": pageContent?.title || "KVKK Aydınlatma Metni",
            "description": pageContent?.meta_description || "Kişisel Verilerin Korunması Kanunu kapsamında aydınlatma metni.",
